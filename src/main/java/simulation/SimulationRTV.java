...
////                if (r.getNumPassengers() + v.getCurrentLoad() > v.getCapacity()) {
////                    continue;
////                }
////
...
////                if (Method.feasibleSequence(new Node[]{v.getLastVisitedNode(), r.getNodePk()})) {
...
////                    visit.setUsers(trip1);
////                    //visit.getUsers().addAll(v.getUsers());
////
////                    // Add trip at level 1
...
////                    Set<User> requests = candidateVisit.getUsers();
////
