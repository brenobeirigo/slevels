...
//
//    @Override
//    public void interruptRebalancing(Vehicle vehicle, int timeWindowSec, boolean showInfo, boolean createEpisode) {
//
...
//        if (createEpisode) {
//
//            int roundsToFindUser = (Dao.getInstance().getDistSec(currentNode, middleNode) / timeWindowSec);
//
